				...
				if ( ! empty( $shop_isle_banners_decoded ) ) :
					...
					foreach ( $shop_isle_banners_decoded as $shop_isle_banner ) :
						...
						if ( ! empty( $shop_isle_banner->image_url ) ) {
							...
							$shop_isle_alt_image = '';
					        $image_id = function_exists( 'attachment_url_to_postid' ) ? attachment_url_to_postid( $shop_isle_banner->image_url ) : '';
							...
							if ( ! empty( $shop_isle_banner->link ) ) {
								...
								if ( function_exists( 'icl_t' ) && ! empty( $shop_isle_banner->id ) ) {
									...
									echo '<a href="' . esc_url( $shop_isle_banner_link ) . '"><img src="' . esc_url( $shop_isle_banner_image_url ) . '" ' . $shop_isle_alt_image . '></a>';
								} else {
									echo '<a href="' . esc_url( $shop_isle_banner->link ) . '"><img src="' . esc_url( $shop_isle_banner->image_url ) . '" ' . $shop_isle_alt_image . '></a>';
								}
							} else {
								if ( function_exists( 'icl_t' ) && ! empty( $shop_isle_banner->id ) ) {
									$shop_isle_banner_image_url = icl_t( 'Banner ' . $shop_isle_banner->id, 'Banner image', $shop_isle_banner->image_url );
